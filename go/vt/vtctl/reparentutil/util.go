...
func ChooseNewPrimary(
	...
	logger.Printf("ChooseNewPrimary(primaryCell:%q tabletMap:%v)", primaryCell, tabletMap)
	...
	logger.Printf("ChooseNewPrimary(validTablets:%v)", validTablets)
	...
	logger.Printf("ChooseNewPrimary(validTablets[0].Alias:%v)", validTablets[0].Alias)
